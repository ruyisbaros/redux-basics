...
const CartItem = ({ img, title, price, amount, remove, increase, decrease }) => {
  return (
    <div className="cart-item">
      ...
      <div>
        {/* increase amount */}
        <button className="amount-btn" onClick={() => increase()}>increase
...
const mapDispatchToProps = (dispatch, ownProps) => {  //mapStateToProps ==>> Bir prop gececeksek. burda prop gecmemize gerek yok
